...
# Emplacement de la base de données (sécurisé pour Render ou local pour VS Code)
...
def init_db():
    with sqlite3.connect(DB_NAME) as conn:
        ...
        # Configuration initiale par défaut des mots de passe s'ils n'existent pas
        ...
        # Configuration initiale des articles s'ils n'existent pas
