...
# Fichier local autonome pour éviter le blocage du plan gratuit de Render
...
def init_db():
    with sqlite3.connect(DB_NAME) as conn:
        ...
        # Insertion des articles et chambres de départ si la base est neuve
...
def executer_action():
    ...
    with sqlite3.connect(DB_NAME) as conn:
        ...
        if action == "vente":
            ...
            # Correction de l'extraction : res[0] = quantité dispo, res[1] = prix de vente unitaire
