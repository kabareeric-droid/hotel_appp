...
# Utilisation d'une base de données locale pour s'adapter au plan gratuit Render
...
def init_db():
    with sqlite3.connect(DB_NAME) as conn:
        ...
        # 1. Table des Utilisateurs (Gestion des accès)
        cursor.execute(
            """
        ...
        # Insertion des comptes par défaut si la base est neuve
        ...
        # Insertion des articles de départ si vide
    ...
    with sqlite3.connect(DB_NAME) as conn:
        ...
        if action == "vente":
            ...
            if res and res[0] >= qte:
                prix_de_vente = res[1]  # Extraction correcte du prix de vente
                ...
                return jsonify({"erreur": "Stock insuffisant ou invalide"}), 400
